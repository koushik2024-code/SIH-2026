...
class ProximityAnalysisEngine:
    ...
    def calculate_scores(self, joined_gdf, fire_id_col="fire_id"):
        """
        Assigns proximity scores based on distance bands.
        ...
        scored = joined_gdf.sort_values(by="buffer_distance").drop_duplicates(subset=[fire_id_col, "facility_id"], keep="first").copy()
    ...
    def run_analysis(self, fires_gdf, facilities_gdf, fire_id_col="fire_id", facility_id_col="facility_id"):
        ...
        scored_gdf = self.calculate_scores(joined_gdf, fire_id_col)
